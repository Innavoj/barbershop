<template>
    <v-app class="w-100 d-flex flex-column align-center text-center pa-2 animation-opacity">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad, voluptas.</p>
        <v-sheet class="w-100 my-12">
            ...
            <v-form class="w-100 p-3">
                ...
                <v-row dense>
                    ...
                    <v-col cols="12" class="my-4">
                        <v-textarea label="Mensaje" variant="outlined" v-model="comments"></v-textarea>
                    </v-col>
                    <v-col cols="12" class="my-4">
